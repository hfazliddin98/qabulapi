...
SECRET_KEY = 'django-insecure-nc!2wy1b1my(c#y79(%e5_@b=g!7woyavht2(h&v8i6xjy7%d3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


ALLOWED_HOSTS = ['.kokanddeveloper.uz', '.pythonanywhere.com', 'localhost', '192.168.0.55','127.0.0.1']
CSRF_TRUSTED_ORIGINS=['https://kspi.pythonanywhere.com', 'http://kspi.pythonanywhere.com', 'http://127.0.0.1']
